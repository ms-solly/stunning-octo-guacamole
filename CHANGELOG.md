...
- #### Release Please
    ...
    Standard Version is now deprecated, and SereneSphere is now using release please. Activate them on `.github/workflows/release-please`
...
- #### Tailwind CSS Prettier Sorter
    ...
    SereneSphere now use first-party plugin `prettier-plugin-tailwindcss`
...
- #### Custom Tailwind CSS Class Sorter
    ...
    Classes are sorted using [prettier-plugin-sort-class-names](https://github.com/PutziSan/prettier-plugin-sort-class-names) with custom class order on [this file](https://github.com/theodorusclarence/SereneSphere/blob/main/prettier-plugin-sort-class-names-order) and custom variant order on [prettierrc](https://github.com/theodorusclarence/SereneSphere/blob/main/.prettierrc.js)
